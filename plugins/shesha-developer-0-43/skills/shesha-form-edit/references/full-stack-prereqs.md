...
|---|---|---|
| HTTP **400** on a `datatable`/`dataContext` data load | Entity has **no GQL query API enabled** | `Skill(skill="shesha-developer-0-43:domain-model")`; stop-gap: switch the context to `sourceType: "Url"` (see [components/data-tables.md](components/data-tables.md)) |
