...
- The groups index (`../../../clean-form-config/assets/groups/base.json` → `_formSettings.scripts`) lists `form`/`setFormData`/`formMode` in the `onBeforeDataLoad` context — runtime disagrees; trust runtime.
